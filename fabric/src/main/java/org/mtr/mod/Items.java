...
public final class Items {
	...
	static {
		...
		RAIL_CONNECTOR_130 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_130"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.OBSIDIAN2, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_130_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_130_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.OBSIDIAN2, itemSettings)), CreativeModeTabs.CORE);
