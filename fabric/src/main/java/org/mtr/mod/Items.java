...
public final class Items {
	...
	static {
		...
		RAIL_CONNECTOR_90 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_90"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.IRON2, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_90_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_90_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.IRON2, itemSettings)), CreativeModeTabs.CORE);
